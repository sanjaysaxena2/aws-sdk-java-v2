...
public final class OneTimeReadTimeoutHandler extends SimpleChannelInboundHandler {
    ...
    private static final String READ_TIMEOUT_HANDLER_NAME = "OneTimeReadTimeoutHandler";
    private final long readTimeoutMillis;
    private final TimeUnit milliseconds;

    OneTimeReadTimeoutHandler(long readTimeoutMillis, TimeUnit milliseconds) {
    ...
    public void channelRead0(ChannelHandlerContext ctx, Object msg) {
        ...
        ctx.pipeline().addFirst(READ_TIMEOUT_HANDLER_NAME, new ReadTimeoutHandler(readTimeoutMillis, milliseconds));
